...
class MidGomPs2Wo(Base):
    ...
    state_date = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"))
...
t_mid_req_development = Table(
    ...
    Column('create_date', DateTime, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")),
...
class SpcRegion(Base):
    ...
    create_time = Column(DateTime, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"))
...
t_tmp_product_height_statistics = Table(
    ...
    Column('create_date', DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")),
