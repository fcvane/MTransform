...
#filename:CheckDatax.sh

day=$1
tabdir=/home/script/datax/log/${day}
...
#补录
find ${tabdir} -name "*.log" | xargs grep "ERROR" | awk -F ':' '{print $1}' | sort -u | awk -F '-' '{print $3}' | awk -F '/' '{print $2}' | awk  -F '_xml' '{print $1}' | awk -F 'OraToPG_' '{print $2}' | sort -u > /home/script/conf/bl.lst
